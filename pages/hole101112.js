              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableItem width={tableConfig[3]}>10</TableItem>
                    <TableItem width={tableConfig[4]}>11</TableItem>
                    <TableItem width={tableConfig[5]}>12</TableItem>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {
                        ...
                        <TableRow bgColor={+rowData[0] % 2 === 0 ? '#ffffff' : '#dadada'}>
                          ...
                          <TableItem width={tableConfig[2]} style={{ 'font-size': '10px', 'text-align': 'left' }}>{rowData[2]}</TableItem>
                          {
                            rowData[3].map((hole, holeIndex) => {
                              if ([10,11,12].includes(holeIndex + 1)) {
                                return (
                                  <TableItem
