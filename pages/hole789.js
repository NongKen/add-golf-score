              ...
              <Table>
                <TableHead>
                  <TableRow bgColor="#99caa7">
                    ...
                    <TableItem width={tableConfig[3]}>7</TableItem>
                    <TableItem width={tableConfig[4]}>8</TableItem>
                    <TableItem width={tableConfig[5]}>9</TableItem>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {
